...
> อัปเดตล่าสุด: **2026-07-28** (SIT **v2.4** — dev-plan share BUGFIX (โชว์แผนพัฒนา ไม่ใช่รูปสวิง) + สรุป/แผนพัฒนาใน History detail + ext `/api/ext/devplan` · v2.3 auto-save + coach cue · v2.2 scale-invariant detection · v2.1 LINE identity + ext API + ROOM login · + **Admin Portal** แยกแอป) · coach `app:sit-v21` rev `00016` · stat-api `stat-api:v2` rev `00002` · **452 tests** · อ่านคู่กับ `CLAUDE.md` (session log เต็ม)
>
